...
class Train():
    ...
    def train(self):
        ...
        pickle_documents = open("yifei_facebook/algos_pickle/documents.pickle","wb")
        ...
        pickle_word_features = open("yifei_facebook/algos_pickle/word_features.pickle","wb")
